package com.naufalazizi.spring.config.profileenvironment;
...
@SpringBootTest(classes = ProfilEnvironmentTest.TestApplication.class)
@ActiveProfiles({"production","local"})
public class ProfilEnvironmentTest {
